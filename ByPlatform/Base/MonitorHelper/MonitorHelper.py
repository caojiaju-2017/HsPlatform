...
if __name__ == "__main__":
    OutPutHelper.consolePrint (MonitorHelper.getHostCpuUseage())
    OutPutHelper.consolePrint(MonitorHelper.getHostDiskUseage())
    OutPutHelper.consolePrint(MonitorHelper.getHostMemoryUseage())